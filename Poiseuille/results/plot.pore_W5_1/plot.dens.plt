...
plot sprintf("../pore_W5_1_F0_20/%s", filename) every ::beg::end u 2:4 w lp ps 0.1 lw 2.0 title 'Fe=0.2', \
     sprintf("../pore_W5_1_F0_40/%s", filename) every ::beg::end u 2:4 w lp ps 0.1 lw 2.0 title 'Fe=0.4'
