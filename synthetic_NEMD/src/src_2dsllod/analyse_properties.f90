...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      PROPNAMES(13) = 'PXX: kinetic '
      PROPNAMES(14) = 'PYY: kinetic '
      PROPNAMES(15) = 'PXY: kinetic '
      PROPNAMES(16) = 'PXX_TOT '
      PROPNAMES(17) = 'PYY_TOT '
      PROPNAMES(18) = 'PXY_TOT '
      PROPNAMES(19) = 'SHEAR RATE '
      PROPNAMES(20) = 'ZETA '
      PROPNAMES(21) = 'VOLUME '
...
!!! write out some data in new file for use in perl scripts
      ...
      WRITE(22,*) B(19),',',SE(19)  !SHEAR RATE 
      WRITE(22,*) B(1),',',SE(1)  !temperature
      WRITE(22,*) B(2),',',SE(2)  !density
      WRITE(22,*) B(21),',',SE(21)  !VOLUME
      WRITE(22,*) B(3),',',SE(3)  !pressure
      WRITE(22,*) B(6),',',SE(6)  !ETOT per particle
      WRITE(22,*) B(9),',',SE(9)  !PV per particle
      WRITE(22,*) B(16),',',SE(16)  !PXX 
      WRITE(22,*) B(17),',',SE(17)  !PYY 
      WRITE(22,*) B(18),',',SE(18)  !PXY
      WRITE(22,*) B(20),',',SE(20)  !ZETA 
